...
function language_strings_handling_messages() {
	...
	language_strings_try_to_download["SPANISH"]="wifibreacher intentará descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="wifibreacher va essayer de télécharger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="wifibreacher intentarà descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O wifibreacher tentará baixar o arquivo de tradução..."
	language_strings_try_to_download["RUSSIAN"]="wifibreacher попытается загрузить языковой файл..."
	language_strings_try_to_download["GREEK"]="Το wifibreacher θα προσπαθήσει να κατεβάσει το αρχείο γλωσσών..."
	language_strings_try_to_download["ITALIAN"]="wifibreacher cercherá di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="wifibreacher spróbuje pobrać plik tłumaczeń..."
	language_strings_try_to_download["GERMAN"]="wifibreacher wird versuchen, die Übersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="wifibreacher çeviri dosyasını indirmeye çalışacak..."
	language_strings_try_to_download["ARABIC"]="سيحاول wifibreacher تنزيل ملف سلاسل اللغة ..."
	language_strings_try_to_download["CHINESE"]="wifibreacher 将尝试下载语言支持文件..."
	...
	language_strings_first_time["SPANISH"]="Si estás viendo este mensaje tras una actualización automática, ¡no te asustes! probablemente es porque a partir de la versión 6.1 la estructura de ficheros de wifibreacher ha cambiado. Se reparará automáticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message après une mise à jour automatique ne vous inquiétez pas! A partir de la version 6.1 la structure de fichier d'wifibreacher a changé. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si estàs veient aquest missatge després d'una actualització automàtica, no t'espantis! probablement és perquè a partir de la versió 6.1 l'estructura de fitxers de wifibreacher ha canviat. Es repararà automàticament"
	language_strings_first_time["PORTUGUESE"]="Se você está vendo esta mensagem depois de uma atualização automática, não tenha medo! A partir da versão 6.1 da estrutura de arquivos do wifibreacher mudou. Isso será corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="Если вы видите это сообщение после автоматического обновления, не переживайте! Вероятно, это объясняется тем, что, начиная с версии 6.1, wifibreacher имеет другую структуру файлов. Проблема будет разрешена автоматически"
	language_strings_first_time["GREEK"]="Εάν βλέπετε αυτό το μήνυμα μετά από κάποια αυτόματη ενημέρωση, μην τρομάξετε! Πιθανόν είναι λόγω της διαφορετικής δομής του wifibreacher μετά από την έκδοση 6.1. Θα επιδιορθωθεί αυτόματα"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente è perché a partire dalla versione 6.1 é cambiata la struttura dei file di wifibreacher. Sarà riparato automaticamente"
	language_strings_first_time["POLISH"]="Jeśli widzisz tę wiadomość po automatycznej aktualizacji, nie obawiaj się! To prawdopodobnie dlatego, że w wersji 6.1 zmieniła się struktura plików wifibreacher. Naprawi się automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von wifibreacher geändert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir güncellemeden sonra bu mesajı görüyorsanız, korkmayın! muhtemelen 6.1 sürümünden itibaren wifibreacher dosya yapısı değişmiştir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="إذا كنت ترى هذه الرسالة بعد التحديث التلقائي ، فلا تخف! ربما يرجع السبب في ذلك إلى أن wifibreacher له بنية ملفات مختلفة منذ الإصدار 6.1. سيتم إصلاحه تلقائياً "
	language_strings_first_time["CHINESE"]="如果您在自动更新后看到此消息，请不要害怕！这可能是因为 wifibreacher 从 6.1 版本开始有不同的文件结构。会自动修复"
	...
	language_strings_exiting["FRENCH"]="Fermeture du script wifibreacher v${wifibreacher_version} - À bientôt! :)"
	language_strings_exiting["CATALAN"]="Sortint de wifibreacher script v${wifibreacher_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script wifibreacher v${wifibreacher_version} - Até breve! :)"
	language_strings_exiting["RUSSIAN"]="Выход из скрипта wifibreacher v${wifibreacher_version} - До встречи! :)"
	language_strings_exiting["GREEK"]="Κλείσιμο του wifibreacher v${wifibreacher_version} - Αντίο :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script wifibreacher v${wifibreacher_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyjście z skryptu wifibreacher v${wifibreacher_version} - Do zobaczenia wkrótce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen wifibreacher v${wifibreacher_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="wifibreacher yazılımından çıkış yapılıyor v${wifibreacher_version} - Yakında görüşürüz! :)"
	language_strings_exiting["ARABIC"]="الخروج من البرنامج wifibreacher v${wifibreacher_version}- نراكم قريبًا! :)"
	language_strings_exiting["CHINESE"]="退出 wifibreacher 脚本 v${wifibreacher_version} - 待会见！ :)"
