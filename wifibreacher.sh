#!/usr/bin/env bash
#Title........: wifibreacher.sh
#Description..: This is a multi-use bash script for Linux systems to audit wireless networks.
#Author.......: Bilal Khan
#Version......: 12.01
#Usage........: bash wifibreacher.sh
...
rc_file_name=".wifibreacherrc"
alternative_rc_file_name="wifibreacherrc"
...
github_user="bilalkhan"
github_repository="wifibreacher"
branch="master"
script_filename="wifibreacher.sh"
...
#Tmux vars
wifibreacher_uid=""
session_name="wifibreacher"
tmux_main_window="wifibreacher-Main"
no_hardcore_exit=0

#Cleanup function - runs commands sequentially when script exits
...
function language_strings_handling_messages() {
	...
	language_strings_no_file["PORTUGUESE"]="Erro. O arquivo de tradu????o n??o foi encontrado"
	language_strings_no_file["RUSSIAN"]="????????????. ???? ???????????? ???????????????? ????????"
	language_strings_no_file["GREEK"]="????????????. ???? ???????????? ?????????????? ?????? ??????????????"
	language_strings_no_file["ITALIAN"]="Errore. Non si trova il file delle traduzioni"
	language_strings_no_file["POLISH"]="B????d. Nie znaleziono pliku t??umaczenia"
	language_strings_no_file["GERMAN"]="Fehler. Die ??bersetzungsdatei wurde nicht gefunden"
	language_strings_no_file["TURKISH"]="Hata. ??eviri dosyas?? bulunamad??"
	language_strings_no_file["ARABIC"]="??????. ?????? ?????????? ?????? ??????????"
	language_strings_no_file["CHINESE"]="????????????????????????????????????"
	...
	language_strings_file_mismatch["SPANISH"]="Error. El fichero de traducciones encontrado no es la versi??n esperada"
	language_strings_file_mismatch["FRENCH"]="Erreur. Les traductions trouv??es ne sont pas celles attendues"
	language_strings_file_mismatch["CATALAN"]="Error. El fitxer de traduccions trobat no ??s la versi?? esperada"
	language_strings_file_mismatch["PORTUGUESE"]="Erro. O a vers??o do arquivos de tradu????o encontrado ?? a incompat??vel"
	language_strings_file_mismatch["RUSSIAN"]="????????????. ???????????????? ???????? ???? ?????????????????????????? ?????????????????? ????????????"
	language_strings_file_mismatch["GREEK"]="????????????. ???? ???????????? ?????????????? ?????? ???????? ???????????? ?????? ?????????????????????? ???? ?????? ???????????????????????????? ????????????"
	language_strings_file_mismatch["ITALIAN"]="Errore. Il file delle traduzioni trovato non ?? la versione prevista"
	language_strings_file_mismatch["POLISH"]="B????d. Znaleziony plik t??umaczenia nie jest oczekiwan?? wersj??"
	language_strings_file_mismatch["GERMAN"]="Fehler. Die gefundene ??bersetzungsdatei ist nicht die erwartete Version"
	language_strings_file_mismatch["TURKISH"]="Hata. Bulunan ??eviri dosyas?? beklenen s??r??m de??il"
	language_strings_file_mismatch["ARABIC"]="??????. ?????? ?????????? ?????????????????? ???? ?????????????? ??????????????"
	language_strings_file_mismatch["CHINESE"]="?????????????????????????????????????????????????????????"

	declare -gA language_strings_try_to_download
	language_strings_try_to_download["ENGLISH"]="wifibreacher will try to download the language strings file..."
	language_strings_try_to_download["SPANISH"]="wifibreacher intentar?? descargar el fichero de traducciones..."
	language_strings_try_to_download["FRENCH"]="wifibreacher va essayer de t??l??charger les fichiers de traductions..."
	language_strings_try_to_download["CATALAN"]="wifibreacher intentar?? descarregar el fitxer de traduccions..."
	language_strings_try_to_download["PORTUGUESE"]="O wifibreacher tentar?? baixar o arquivo de tradu????o..."
	language_strings_try_to_download["RUSSIAN"]="wifibreacher ???????????????????? ?????????????????? ???????????????? ????????..."
	language_strings_try_to_download["GREEK"]="???? wifibreacher ???? ?????????????????????? ???? ?????????????????? ???? ???????????? ??????????????..."
	language_strings_try_to_download["ITALIAN"]="wifibreacher cercher?? di scaricare il file delle traduzioni..."
	language_strings_try_to_download["POLISH"]="wifibreacher spr??buje pobra?? plik t??umacze??..."
	language_strings_try_to_download["GERMAN"]="wifibreacher wird versuchen, die ??bersetzungsdatei herunterzuladen..."
	language_strings_try_to_download["TURKISH"]="wifibreacher ??eviri dosyas??n?? indirmeye ??al????acak..."
	language_strings_try_to_download["ARABIC"]="???????????? wifibreacher ?????????? ?????? ?????????? ?????????? ..."
	language_strings_try_to_download["CHINESE"]="wifibreacher ?????????????????????????????????..."
	...
	language_strings_successfully_downloaded["SPANISH"]="Se ha descargado con ??xito el fichero de traducciones"
	language_strings_successfully_downloaded["FRENCH"]="Les fichiers traduction ont ??t?? correctement t??l??charg??s"
	language_strings_successfully_downloaded["CATALAN"]="S'ha descarregat amb ??xit el fitxer de traduccions"
	language_strings_successfully_downloaded["PORTUGUESE"]="O arquivo de tradu????o foi baixado com sucesso"
	language_strings_successfully_downloaded["RUSSIAN"]="???????????????? ???????? ?????? ?????????????? ????????????????"
	language_strings_successfully_downloaded["GREEK"]="???? ???????????? ?????????????? ???????????????? ???? ????????????????"
	language_strings_successfully_downloaded["ITALIAN"]="Il file delle traduzioni ?? stato scaricato con successo"
	language_strings_successfully_downloaded["POLISH"]="Plik z t??umaczeniem zosta?? pomy??lnie pobrany"
	language_strings_successfully_downloaded["GERMAN"]="Die ??bersetzungsdatei wurde erfolgreich heruntergeladen"
	language_strings_successfully_downloaded["TURKISH"]="??eviri dosyas?? ba??ar??yla indirildi"
	language_strings_successfully_downloaded["ARABIC"]="???? ?????????? ?????? ?????????? ?????????? ??????????"
	language_strings_successfully_downloaded["CHINESE"]="?????????????????????????????????"
	...
	language_strings_failed_downloading["SPANISH"]="No se ha podido descargar el fichero de traducciones. Comprueba tu conexi??n a internet o desc??rgalo manualmente de ${normal_color}${urlgithub}"
	language_strings_failed_downloading["FRENCH"]="Impossible de t??l??charger le fichier traduction. V??rifiez votre connexion ?? internet ou t??l??chargez le fichier manuellement ${normal_color}${urlgithub}"
	language_strings_failed_downloading["CATALAN"]="No s'ha pogut descarregar el fitxer de traduccions. Comprova la connexi?? a internet o descarrega'l manualment de ${normal_color}${urlgithub}"
	language_strings_failed_downloading["PORTUGUESE"]="N??o foi poss??vel baixar o arquivos de tradu????o. Verifique a sua conex??o com a internet ou baixe manualmente em ${normal_color}${urlgithub}"
	language_strings_failed_downloading["RUSSIAN"]="???????????????? ???????? ???? ?????????? ???????? ????????????????. ?????????????????? ?????????????????????? ?? ?????????????????? ?????? ?????????????????? ?????? ?????????????? ?? ${normal_color}${urlgithub}"
	language_strings_failed_downloading["GREEK"]="???? ???????????? ?????????????? ?????? ???????????? ???? ??????????????. ?????????????? ???? ?????????????? ?????? ???? ???? ?????????????????? ?? ?????????????????? ???? ?????????????????????? ${normal_color}${urlgithub}"
	...
	language_strings_failed_downloading["POLISH"]="Nie mo??na pobra?? pliku t??umaczenia. Sprawd?? po????czenie internetowe lub pobierz go r??cznie z ${normal_color}${urlgithub}"
	language_strings_failed_downloading["GERMAN"]="Die ??bersetzungsdatei konnte nicht heruntergeladen werden. ??berpr??fen Sie Ihre Internetverbindung oder laden Sie sie manuell von ${normal_color}${urlgithub} runter"
	language_strings_failed_downloading["TURKISH"]="??eviri dosyas?? indirilemedi. ??nternet ba??lant??n??z?? kontrol edin veya manuel olarak indirin ${normal_color}${urlgithub}"
	language_strings_failed_downloading["ARABIC"]="${normal_color}${urlgithub}${red_color} ???? ???????? ?????????? ?????? ??????????. ???????? ???? ???????????? ?????????????????? ???? ???? ?????????????? ???????????? ????"
	language_strings_failed_downloading["CHINESE"]="?????????????????????????????????????????????????????????????????? ???????????? ${normal_color}${urlgithub}"

	declare -gA language_strings_first_time
	language_strings_first_time["ENGLISH"]="If you are seeing this message after an automatic update, don't be scared! It's probably because wifibreacher has different file structure since version 6.1. It will be automatically fixed"
	language_strings_first_time["SPANISH"]="Si est??s viendo este mensaje tras una actualizaci??n autom??tica, ??no te asustes! probablemente es porque a partir de la versi??n 6.1 la estructura de ficheros de wifibreacher ha cambiado. Se reparar?? autom??ticamente"
	language_strings_first_time["FRENCH"]="Si vous voyez ce message apr??s une mise ?? jour automatique ne vous inqui??tez pas! A partir de la version 6.1 la structure de fichier d'wifibreacher a chang??. L'ajustement se fera automatiquement"
	language_strings_first_time["CATALAN"]="Si est??s veient aquest missatge despr??s d'una actualitzaci?? autom??tica, no t'espantis! probablement ??s perqu?? a partir de la versi?? 6.1 l'estructura de fitxers de wifibreacher ha canviat. Es reparar?? autom??ticament"
	language_strings_first_time["PORTUGUESE"]="Se voc?? est?? vendo esta mensagem depois de uma atualiza????o autom??tica, n??o tenha medo! A partir da vers??o 6.1 da estrutura de arquivos do wifibreacher mudou. Isso ser?? corrigido automaticamente"
	language_strings_first_time["RUSSIAN"]="???????? ???? ???????????? ?????? ?????????????????? ?????????? ?????????????????????????????? ????????????????????, ???? ??????????????????????! ????????????????, ?????? ?????????????????????? ??????, ??????, ?????????????? ?? ???????????? 6.1, wifibreacher ?????????? ???????????? ?????????????????? ????????????. ???????????????? ?????????? ?????????????????? ??????????????????????????"
	language_strings_first_time["GREEK"]="?????? ?????????????? ???????? ???? ???????????? ???????? ?????? ???????????? ???????????????? ??????????????????, ?????? ??????????????????! ?????????????? ?????????? ???????? ?????? ???????????????????????? ?????????? ?????? wifibreacher ???????? ?????? ?????? ???????????? 6.1. ???? ???????????????????????? ????????????????"
	language_strings_first_time["ITALIAN"]="Se stai vedendo questo messaggio dopo un aggiornamento automatico, niente panico! probabilmente ?? perch?? a partire dalla versione 6.1 ?? cambiata la struttura dei file di wifibreacher. Sar?? riparato automaticamente"
	language_strings_first_time["POLISH"]="Je??li widzisz t?? wiadomo???? po automatycznej aktualizacji, nie obawiaj si??! To prawdopodobnie dlatego, ??e w wersji 6.1 zmieni??a si?? struktura plik??w wifibreacher. Naprawi si?? automatycznie"
	language_strings_first_time["GERMAN"]="Wenn Sie diese Nachricht nach einem automatischen Update sehen, haben Sie keine Angst! Das liegt vermutlich daran, dass ab Version 6.1 die Dateistruktur von wifibreacher ge??ndert wurde. Es wird automatisch repariert"
	language_strings_first_time["TURKISH"]="Otomatik bir g??ncellemeden sonra bu mesaj?? g??r??yorsan??z, korkmay??n! muhtemelen 6.1 s??r??m??nden itibaren wifibreacher dosya yap??s?? de??i??mi??tir. Otomatik olarak tamir edilecektir"
	language_strings_first_time["ARABIC"]="?????? ?????? ?????? ?????? ?????????????? ?????? ?????????????? ???????????????? ?? ?????? ??????! ???????? ???????? ?????????? ???? ?????? ?????? ???? wifibreacher ???? ???????? ?????????? ???????????? ?????? ?????????????? 6.1. ???????? ???????????? ???????????????? "
	language_strings_first_time["CHINESE"]="????????????????????????????????????????????????????????????????????????????????? wifibreacher ??? 6.1 ??????????????????????????????????????????????????????"

	declare -gA language_strings_exiting
	language_strings_exiting["ENGLISH"]="Exiting wifibreacher script v${wifibreacher_version} - See you soon! :)"
	language_strings_exiting["SPANISH"]="Saliendo de wifibreacher script v${wifibreacher_version} - Nos vemos pronto! :)"
	language_strings_exiting["FRENCH"]="Fermeture du script wifibreacher v${wifibreacher_version} - ?? bient??t! :)"
	language_strings_exiting["CATALAN"]="Sortint de wifibreacher script v${wifibreacher_version} - Ens veiem aviat! :)"
	language_strings_exiting["PORTUGUESE"]="Saindo do script wifibreacher v${wifibreacher_version} - At?? breve! :)"
	language_strings_exiting["RUSSIAN"]="?????????? ???? ?????????????? wifibreacher v${wifibreacher_version} - ???? ??????????????! :)"
	language_strings_exiting["GREEK"]="???????????????? ?????? wifibreacher v${wifibreacher_version} - ?????????? :)"
	language_strings_exiting["ITALIAN"]="Uscendo dallo script wifibreacher v${wifibreacher_version} - A presto! :)"
	language_strings_exiting["POLISH"]="Wyj??cie z skryptu wifibreacher v${wifibreacher_version} - Do zobaczenia wkr??tce! :)"
	language_strings_exiting["GERMAN"]="Sie verlassen wifibreacher v${wifibreacher_version} - Bis bald! :)"
	language_strings_exiting["TURKISH"]="wifibreacher yaz??l??m??ndan ????k???? yap??l??yor v${wifibreacher_version} - Yak??nda g??r??????r??z! :)"
	language_strings_exiting["ARABIC"]="???????????? ???? ???????????????? wifibreacher v${wifibreacher_version}- ?????????? ????????????! :)"
	language_strings_exiting["CHINESE"]="?????? wifibreacher ?????? v${wifibreacher_version} - ???????????? :)"
	...
	language_strings_key_to_continue["RUSSIAN"]="?????????????? ?????????????? [Enter] ?????? ??????????????????????..."
	language_strings_key_to_continue["GREEK"]="?????????????? ???? ???????????? [Enter] ?????? ???? ????????????????????..."
	language_strings_key_to_continue["ITALIAN"]="Premere il tasto [Enter] per continuare..."
	language_strings_key_to_continue["POLISH"]="Naci??nij klawisz [Enter] aby kontynuowa??..."
	language_strings_key_to_continue["GERMAN"]="Dr??cken Sie die [Enter]-Taste um fortzufahren..."
	language_strings_key_to_continue["TURKISH"]="Devam etmek i??in [Enter] tu??una bas??n..."
	language_strings_key_to_continue["ARABIC"]="???????? ?????? ?????????? [Enter] ???????????????? ..."
	language_strings_key_to_continue["CHINESE"]="??? [Enter] ?????????..."
}
...
#Calculate pin based on Stefan Viehb??ck algorithm (EasyBox)
